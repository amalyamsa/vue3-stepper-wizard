...
<template>
  ...
  >
     <ul
      class="stepper-track list-unstyled d-flex flex-nowrap align-items-start justify-content-center justify-content-md-between gap-4 gap-md-3 m-0 p-2 p-md-3 border rounded bg-white"
      role="list"
    >
      <li
